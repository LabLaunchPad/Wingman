...
- **Adaptive commands** (`commands/retro.md`, `learn.md`, `evolve.md`, `harness.md`, `telemetry.md`, `launch.md`, `hotfix.md`, `audit.md`, `over-engineering-review.md`, `bloat-audit.md`, `debt-ledger.md`) — invoked as needed, not part of the fixed pipeline.
