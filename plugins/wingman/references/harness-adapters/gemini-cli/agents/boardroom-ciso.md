...
model: gemini-3-pro  # Wingman's own source agent pins model: opus (a higher tier) for this seat -- set this to your Gemini CLI install's strongest available model.
---
