...
When Step 2's ambiguity is genuinely consequential (more than one reasonable interpretation, and picking wrong is expensive to undo), ask the founder rather than silently choosing one — this is the one point in the workflow where minimalism doesn't mean "decide fast," it means "confirm cheaply before building."
