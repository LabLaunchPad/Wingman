...
`LEARNINGS.md`, `docs/wingman/retros.md`, and `.wingman/checkpoints.jsonl` — the three signal sources step 1 reads fresh, never from a remembered impression of this project's history.
