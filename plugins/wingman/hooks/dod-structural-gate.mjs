...
// Memory-optimized recursive directory walker utilizing a flat accumulator pattern
// to avoid high garbage collection overhead and O(N^2) array copies from .concat().
