...
node plugins/wingman/scripts/validate-engines.mjs       # engine contract: every command/skill/hook/reference has exactly one of the 17 engines as owner
