...
| T4 | Prompt-injection / role manipulation against the 5 boardroom agents reading untrusted plans/diffs | CLOSED | boardroom-security | 2026-07-13 | Each agent carries the Prompt Defense Baseline (no role change, no secret disclosure, untrusted external data). No new untrusted-input path added by v9–v12. |
