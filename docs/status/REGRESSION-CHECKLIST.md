...
- **`node plugins/wingman/scripts/validate-engines.mjs`** — the 17-engine ownership contract (PR7): every command/skill/hook/reference has exactly one engine owner, no orphans — see `docs/status/ENGINES.md`.
