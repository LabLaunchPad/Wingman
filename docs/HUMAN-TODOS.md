...
### Publishing / release
- ~~This branch has never been merged~~ — **PR #1 is open**: https://github.com/LabLaunchPad/Wingman/pull/1 (updated with a full summary of everything built, since it previously carried the title/body from the very first commit only). Still needs your review and merge — I won't merge it myself. Decide whether `main` should require review going forward once this lands.
