...
Tests `plugins/wingman/scripts/validate-engines.mjs` — the 17-engine ownership contract added in
PR7 of the AI Engineering Operating System build. Fully deterministic — no model-judgment
component — verified by running the real script directly and checking exit codes/output, same
method as `evals/cases/dod-pre-push-check.md`.
...
|---|---|---|
| Real, unmodified 17-manifest tree against the real 119-file plugin scope | `0` | "17 engine(s), 119 real file(s) checked." + "PASS", zero problems listed |
