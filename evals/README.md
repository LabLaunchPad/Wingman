...
- `cases/retro.md` — tests `commands/retro.md` against a project with genuinely rich real history (reusing `full-pipeline-e2e` Run 2's fixture post-ship). `provisional`: gathered real facts, wrote a specific (not generic) retro in the exact required format, and made a reasoned rather than reflexive feed-forward decision about `/wingman:learn`.
